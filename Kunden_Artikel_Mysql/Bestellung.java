...
public class Bestellung {
	...
	public static void Bestellunglöschen(Connection c, int bestellid) {
		Statement stmt;
		try {
			...
			System.out.println();
			stmt.close();
			System.out.println("Bestellung mit der Bestellid " + bestellid + " wurde gelöscht");
		}catch(SQLException e) { 
			e.printStackTrace();
		}
	...
	public static void Bestellungupdaten(Connection c, int bestellid, int anzahl, int neuekundenid, int neueartikelid, int neueanzahl) {
		try {
			...
			stmt.executeUpdate(sql);
			System.out.printf("Bestellung mit der bestellid "+ bestellid +" wurde geändert. Neue kundenid = "+ neuekundenid +"");
			System.out.println();
			stmt.close();
